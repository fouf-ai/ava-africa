          ...
          <form action="https://formspree.io/f/xbdpvpld" method="POST" className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div><label className="block text-sm font-semibold text-gray-700 mb-1">Prénom</label><input type="text" name="prenom" placeholder="Votre prénom" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
                <div><label className="block text-sm font-semibold text-gray-700 mb-1">Nom</label><input type="text" name="nom" placeholder="Votre nom" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
              </div>
              <div><label className="block text-sm font-semibold text-gray-700 mb-1">Email</label><input type="email" name="email" placeholder="votre@email.com" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
              <div className="grid md:grid-cols-2 gap-4">
                <div><label className="block text-sm font-semibold text-gray-700 mb-1">Pays</label><input type="text" name="pays" placeholder="Votre pays" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
                <div><label className="block text-sm font-semibold text-gray-700 mb-1">Âge</label><input type="number" name="age" placeholder="Votre âge" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
              </div>
              <div><label className="block text-sm font-semibold text-gray-700 mb-1">Catégorie souhaitée</label><select name="categorie" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600 bg-white"><option value="">Choisissez une catégorie</option><option value="student">Étudiant / Apprenant (6 000 FCFA/an)</option><option value="young_pro">Jeune Professionnel (15 000 FCFA/an)</option><option value="pro">Professionnel Confirmé (30 000 FCFA/an)</option><option value="bienfaiteur">Bienfaiteur (60 000 FCFA/an)</option><option value="institutional">Membre Institutionnel (organisation)</option></select></div>
              <div><label className="block text-sm font-semibold text-gray-700 mb-1">Programme qui vous intéresse</label><select name="programme" required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600 bg-white"><option value="">Choisissez un programme</option><option value="incubator">Incubateur de Startups</option><option value="hackathon">Hackathons Panafricains</option><option value="mentorship">Programme de Mentorat</option><option value="volunteer">Volontariat d&apos;Urgence</option><option value="women">Women in Tech Africa</option><option value="fellowship">Digital Leaders Fellowship</option><option value="formations">Formations (Cyber, IA, Dev)</option></select></div>
              <div><label className="block text-sm font-semibold text-gray-700 mb-1">Pourquoi souhaitez-vous rejoindre l&apos;AVA ?</label><textarea name="motivation" placeholder="Parlez-nous de votre motivation..." rows={4} required className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-600" /></div>
              <button type="submit" className="w-full bg-green-700 text-white py-4 rounded-lg font-bold text-lg hover:bg-green-800 transition">Envoyer ma candidature</button>
