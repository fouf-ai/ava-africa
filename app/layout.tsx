...
export const metadata: Metadata = {
  ...
  keywords:
    "Africa, youth, cybersecurity, AI, emergencies, scholarships, digital sovereignty, innovation, أفريقيا, الشباب, الأمن السيبراني",
  openGraph: {
    title: "AVA — African Visionaries Alliance",
    description: "See further. Act faster. Build Africa.",
    type: "website",
    locale: "fr_FR",
